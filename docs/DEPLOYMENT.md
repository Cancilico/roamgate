...
| `ROAMGATE_CODEX_NATIVE_COPY=1` | Allow local Codex `/copy` to transfer the server's X11 text clipboard to the initiating browser terminal; requires `DISPLAY`, Python 3, and Tkinter. Disabled by default and unavailable for SSH connections. |
